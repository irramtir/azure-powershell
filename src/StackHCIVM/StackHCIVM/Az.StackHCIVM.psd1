...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added breaking change announcements for upcoming SecureString parameter type changes in ''New-AzStackHCIVMImage'' and ''New-AzStackHCIVMVirtualMachine'''
